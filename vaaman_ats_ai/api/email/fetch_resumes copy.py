...
def fetch_email_resumes():
    ...
    # email_account = get_decrypted_password("ATS Settings", "ATS Settings", "email_account") or frappe.conf.get("email_account")
    email_account = frappe.db.get_single_value("ATS Settings", "career_email_account") or frappe.conf.get("email_account")
            ...
            for f in valid_files:
                try:
                    ...
                    applicant = frappe.get_doc({
                        ...
                        "job_title": matched_job_id.get("job_opening") if matched_job_id else None,  # ✅ Link to Job Opening
